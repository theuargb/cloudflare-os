...
const SUGGESTIONS: TaskSuggestion[] = [
  {
    ...
    description: 'Створіть документ з даних компанії',
    icon: FileText,
    prompt:
  ...
  },
  {
    id: 'team-meeting',
    label: 'Презентація',
    description: 'Презентація для команди',
    icon: Presentation,
    prompt:
  ...
  {
    id: 'insights',
    label: 'Звіти та аналіз',
    description: 'Створюйте звіти та знаходьте приховану цінність',
    icon: ChartLineUp,
    prompt:
  ...
  },
  {
    id: 'workflow',
    label: 'Автоматизація',
    description: 'Занесіть в базу дані з вхідного електронної пошти',
    icon: Lightning,
    prompt:
  ...
  {
    id: 'app',
    label: 'Створіть бізнес-додаток',
    description: 'Екран, калькулятор чи інтерактивний дашборд',
    icon: AppWindow,
    prompt:
...
export default function HomeTaskSuggestions({
  ...
  return (
    <section aria-label="Приклади запитів" className="flex flex-col gap-1">
